...
('1234567891234','Economy Class','10A','2018-01-10',30,'1'),
('2345678912345','Economy Class','12A','2018-01-15',28,'2'),
('3456789123456','First Class','20B','2018-01-20',29,'3'),
('4567891234567','Economy Class','15A','2018-01-25',28.5,'4'),
('5678912345678','First Class','18A','2018-01-30',26,'5'),
('6789123456789','Economy Class','11A','2018-02-05',25,'6'),
('7891234567891','Economy Class','10B','2018-02-10',15.6,'7'),
('8912345678912','First Class','12B','2018-02-15',14,'8'),
('9123456789123','Economy Class','20B','2018-02-20',15.6,'9'),
('1234560789123','Economy Class','15B','2018-02-25',30,'10');
...
UPDATE FlightAttendant set Designation='Junior Flight Attendant' where StaffID='67891A';
UPDATE FlightAttendant set Designation='Junior Flight Attendant' where StaffID='34567A';
UPDATE FlightAttendant set Designation='Junior Flight Attendant' where StaffID='12345A';
...
WHERE IC.TABLE_CATALOG = 'FlightManagementSystem'
  and IC.TABLE_SCHEMA = 'dbo'
  and IC.TABLE_NAME = 'TakeOff'
